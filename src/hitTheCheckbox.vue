...
export default {
  ...
  methods: {
    ...
    /*async gameTimer(secondsAmmount){
...
<template>
  ...
  <p class="scoreCount">Score: {{ gameScore }}</p>
  ...
  <br />
  <br />
  <button id="startGameButton" class="startButton" v-on:click="startGame">
    Start game!
  </button>
